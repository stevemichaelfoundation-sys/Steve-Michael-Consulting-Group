          ...
          <ul className="infoList">
            ...
            <li className="infoItem">
              ...
              <div>
                ...
                <span className="infoValue">+1 (555) 000-0000</span>
              </div>
            </li>
         ...
         <li className="infoItem">
           <div className="infoIcon">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
               ...
               <div>
                <span className=" infoLabel">follow us on linkedln</span>
                <span className= "infoLabel">https://www.linkedin.com/in/steve-foundation/</span>
              </div>  
              </li>     
          ...
          <div className="social">
            ...
            <div className="socialIcons">
              <Link href="https://twitter.com" className="socialIcon" target="_blank" rel="noopener noreferrer">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z" />
                </svg>
              </Link>
              <Link href="https://www.linkedin.com/company/steve-michael-consulting-group/" className="socialIcon" target="_blank" rel="noopener noreferrer">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <Link 
              ...
              <Link href="https://instagram.com" className="socialIcon" target="_blank" rel="noopener noreferrer">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
